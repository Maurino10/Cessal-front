<template>
    <label class="ml-2 text-sm font-medium leading-9 tracking-wide text-gray-500">{{ props.label }}</label>
...
<script setup>
    ...
    const props = defineProps(['label', 'placeholder', 'items', 'value', 'title', 'disabled']);
