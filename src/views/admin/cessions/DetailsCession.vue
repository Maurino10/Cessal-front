...
// Imports
    ...
    import adminService from '@/services/cessions/adminService';
...
// Functions
    ...
    const fetchCession = async () => {
        try {
            const response = await adminService.getCession(route.params.id);
    ...
    const fetchCessionBorrowers = async () => {
        try {
            const response = await adminService.getAllCessionBorrowerByCession(route.params.id);
    ...
    const fetchCessionJustificatifs = async () => {
        try {
            const response = await adminService.getAllCessionJustificatifByCession(route.params.id);
    ...
    const fetchCessionLenders = async () => {
        try {
            const response = await adminService.getAllCessionLenderByCession(route.params.id);
