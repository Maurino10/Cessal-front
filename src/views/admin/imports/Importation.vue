    ...
    <div class="main-body">
        <v-row class="mt-1">
                <v-col md="12" sm="12" cols="12">
                    <h3 class="text-xl">Type de données à importer</h3>
                </v-col>
                <v-col cols="12" md="12">
                    ...
                    <div class="flex items-center justify-between p-8 bg-white border rounded-lg">
                        ...
                        <div class="flex gap-4 mt-2">
                           ...
                           <!-- <VButton title="Télécharger le modèle" icon="mdi-tray-arrow-down" class="btn-cancel" />
                           <VButton title="Uploader un fichier" icon="mdi-tray-arrow-up" class="btn-submit" @click="handleAction('upload',  null)" /> -->
                        </div>  
                    </div>
