...
export default {
    ...
    getAllCessionByTPI(idTPI) {
        return axios.get(`/administrateur/local/tpi/${idTPI}/cessions`);
    },

    filterCessionByTPI(idTPI, statut, dateStart, dateEnd) {
        return axios.get(`/administrateur/local/tpi/${idTPI}/cessions/filter?statut=${statut}&dateStart=${dateStart}&dateEnd=${dateEnd}`);
    },
